...
{
    [Guid("44b922b1-6cb6-4ed1-b308-bd0be1ca8658")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": UpdateUserParametersPlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");
        ...
        {
            Trace.TraceInformation(": UpdateUserParametersPlugin: deactivating... ");
